...
f"{'implicit '}{'concatenation'}"
t"{'implicit '}{'concatenation'}"

# Outer implicit concatenation with escaped quotes.
f'"double" quotes and {"implicit "}{"concatenation"} with "double" quotes'
t'"double" quotes and {"implicit "}{"concatenation"} with "double" quotes'
f"'single' quotes and {'implicit '}{'concatenation'} with \"double\" quotes"
t"'single' quotes and {'implicit '}{'concatenation'} with \"double\" quotes"
f"\"double\" quotes and {'implicit '}{'concatenation'} with 'single' quotes"
t"\"double\" quotes and {'implicit '}{'concatenation'} with 'single' quotes"
f"'single' quotes and {'implicit '}{'concatenation'} with 'single' quotes"
t"'single' quotes and {'implicit '}{'concatenation'} with 'single' quotes"
